...
def doit():
    ...
    with open(src_dir / "conv.s") as f:
        ...
        while i < len(lines):
            ...
            0x553a,0x90af,0x90b3,0xe81d,0xbbeb,0xbf1f,0xed8a,0xedf1,0xcd90,0x9052,0xe8fb,0xe20f,0x9e63,0x9e6e,0xa4f0,
            0X9ea0,0Xde54,0Xe268,0x960a,0xd6d2,0xe151,0Xde85,0xdab2,0Xbfb2,0Xbfbc,0Xbc78,0xbde2,0X9fe4,
            0xbce3,0xbf05,0xa12d,0xa18c,0Xa511,0xc37f,0xA04C,0xc352,0x9abd,0x9ed7,0x9f21,0x9a9a,0x9eb4,
            0xe183,0x99df,
            ...
            if line_address == 0xCC75:
                line += "\tst.b    vector_frame_ready        | new vector list available\n"
